...
class CreateAirplaneCommandTest {
    ...
    @Test
    void testMarshal() {
        final var createAirplaneCommand = new CreateAirplaneCommand();
        createAirplaneCommand.setModel("a");
        createAirplaneCommand.setIdNumber("1");
        ...
        createAirplaneCommand.setSeatingChart(seatingChart);
        ...
        mar.marshal(createAirplaneCommand, out);
